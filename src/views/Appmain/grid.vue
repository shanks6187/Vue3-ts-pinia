<template>
    <div>
        <van-grid :column-num="5" :border="false">
            <van-grid-item v-for="item in next" :key="item.navId" :icon="item.url" :text="item.text" @click="tonext(item.text)"/>
        </van-grid>
    </div>
</template>
    ...
    const next = [
        {
            navId: 1,
            text:"锋购超市",
            url:"https://m15.360buyimg.com/mobilecms/jfs/t1/175540/24/19329/6842/60ec0b0aEf35f7384/ec560dbf9b82b90b.png!g70.jpg"
        },{
            navId: 2,
            text:"数码电器",
            url:"https://m15.360buyimg.com/mobilecms/jfs/t1/178015/31/13828/6862/60ec0c04Ee2fd63ac/ccf74d805a059a44.png!g70.jpg"
        },{
            navId:3,
            text:"锋购百货",
            ...
            navId: 4,
            text:"锋购生鲜",
            url:"https://m15.360buyimg.com/mobilecms/jfs/t1/177902/16/13776/5658/60ec0e71E801087f2/a0d5a68bf1461e6d.png!g70.jpg"
        },{
            navId: 5,
            text:"锋购到家",
